...
export default function JoinCommunityButton({ communityId, userRole }: JoinCommunityButtonProps) {
  ...
  return (
    <div className="space-y-2">
      <Btn 
        ...
        className={`w-full py-3 text-base bg-accent hover:bg-accent/90 text-white transition-all duration-300 hover:scale-[1.02] ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
      >
